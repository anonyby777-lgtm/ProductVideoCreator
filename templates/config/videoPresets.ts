 ...
 * 2. 在 Root.tsx 中导入并动态生成 Composition
 *
 * @example
 ...
 *
 * @example
 * const fontSize = getResponsiveFontSize(72, width, height); // 1080p 下为 72px
 */
 ...
 *   return { width, height, layout, scale };
 * };
 */
